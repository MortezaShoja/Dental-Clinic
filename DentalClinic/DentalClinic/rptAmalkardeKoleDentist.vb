...
Public Class rptAmalkardeKoleDentist
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAmalkardeKoleDentist.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAmalkardeKoleDentist
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAmalkardeKoleDentist = New rptAmalkardeKoleDentist
        rpt.Site = Me.Site
        Return rpt
    End Function
