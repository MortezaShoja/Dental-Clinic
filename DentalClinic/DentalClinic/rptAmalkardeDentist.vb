...
Public Class rptAmalkardeDentist
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAmalkardeDentist.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAmalkardeDentist
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAmalkardeDentist = New rptAmalkardeDentist
        rpt.Site = Me.Site
        Return rpt
    End Function
